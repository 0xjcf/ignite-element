...
- Guidance distinguishes source truth, view projection, renderer commit, effects, resource cleanup, consumer-owned scheduling, and Actor-Web runtime ownership.

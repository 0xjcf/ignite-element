...
import type { EmptyEventMap, EventBuilder, EventMap, FacadeEffectsLike, FacadeCommandFunction, FacadeCommandResult, FacadeCommandsCallback, FacadeStatesCallback, FacadeViewCallback } from "./RenderArgs";
export type AnyStatesCallback = FacadeStatesCallback<unknown, Record<string, unknown>>;
export type AnyViewCallback = FacadeViewCallback<unknown, Record<string, unknown>>;

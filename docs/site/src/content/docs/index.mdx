...
Try the counter directly in the docs, then inspect the exact released example below.
...
Want to inspect or fork the exact released example?

- [Open the beta.11 XState example](https://github.com/0xjcf/ignite-element/tree/v3.0.0-beta.11/examples/adapters/xstate)

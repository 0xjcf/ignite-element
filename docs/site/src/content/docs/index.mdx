...
The verified public release is `3.0.0-beta.13`. It adds [ready shared-source bindings and terminal disposal after registration](/ignite-element/migration/shared-readiness-terminal-disposal/). Install that exact version or follow the beta channel; stable `ignite-element@latest` remains v2.

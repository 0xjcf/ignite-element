...
sidebar:
  ...
  order: 1
hero:
  tagline: Framework-agnostic custom elements with typed state, commands, effects, and events.
  badge: v2 docs
  actions:
    - text: Install
...
Ignite Element gives you a thin, typed layer around your favorite state library so you can ship web components without bringing a framework runtime. Commands express intent, effects express consequences, and the same component contract can run in the DOM or headlessly.
...
- **Framework wrappers**: No React/Solid runtime required—ship native custom elements with typed commands, effects, and events.

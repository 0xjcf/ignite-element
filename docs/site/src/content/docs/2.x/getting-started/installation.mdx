...
* **Advanced config**: [defineIgniteConfig (ignite-renderer)](/ignite-element/2.x/api/define-ignite-config/)
* **Legacy tooling notes**: [Tooling](/ignite-element/2.x/guides/tooling/)
* **Legacy renderer notes**: [Renderers](/ignite-element/2.x/api/renderers/)

...
sidebar:
  label: Installation
  order: 1
slug: 2.x/getting-started/installation
---
...
# pnpm add ignite-element@2.2.2 @reduxjs/toolkit   # Redux
# pnpm add ignite-element@2.2.2 mobx               # MobX
```
...
* Create a smoke test component via [Your first component](/ignite-element/2.x/getting-started/first-component/).

...
sidebar:
  ...
  order: 2
slug: 2.x/getting-started/first-component
---

This guide assumes you completed [Installation](/ignite-element/2.x/getting-started/installation/). We’ll build a toggle button with XState and the Ignite JSX renderer.
...
Because it’s a web component, you can drop it into plain HTML or a host framework without inventing a wrapper-specific contract. See [Host app integration](/ignite-element/2.x/guides/host-app-integration/) for concrete React and Vue patterns, plus SSR notes.

...
```bash
pnpm add ignite-element@2.2.2 xstate
...
* [Open repo example](https://github.com/0xjcf/ignite-element/tree/fe5e4b435fc914c4e811d420bf2391f6a270db03/src/examples/xstate)

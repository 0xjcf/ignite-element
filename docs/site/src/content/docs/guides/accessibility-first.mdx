...
The [voice and text workbench example](https://github.com/0xjcf/ignite-element/tree/beta/examples/agents/voice-workbench) demonstrates the split in a complete agent-authored interface:

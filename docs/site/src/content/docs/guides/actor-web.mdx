...
See [Choosing `xstate` vs `actor-web`](/ignite-element/concepts/state-adapters/#choosing-ignite-elementxstate-vs-ignite-elementactor-web) for the boundary rationale, and [Redux & MobX](/ignite-element/guides/redux-and-mobx/) for the other two adapters.

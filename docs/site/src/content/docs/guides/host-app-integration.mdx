...
Those views borrow a prepared, unregistered core. A registered core cannot be
disposed like a session owner; the web wrapper is not a generic external-core binding.

...
No setup file or Lit dependency is needed for the Ignite JSX example.

Applications choosing Lit should declare `@ignite-element/renderer` and `lit-html` directly and load that renderer in their own test setup file.

...
- **Set up a real project**: [Project setup](/ignite-element/getting-started/project-setup/) for the Node, TypeScript, testing, and tooling baseline.
- **Understand the model**: [State adapters](/ignite-element/concepts/state-adapters/) and [Events & commands](/ignite-element/concepts/events-and-commands/) explain how `source`, `view`, `commands`, and `effects` fit together.

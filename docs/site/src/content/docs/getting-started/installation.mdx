...
Use the advanced setup only when you need `@ignite-element/renderer` primitives for shared styles or renderer diagnostics. (Using lit is **not** advanced — it is config-free; see [Rendering](/ignite-element/concepts/rendering/).)

...
Keep the config/plugins path for advanced compatibility only. Use `igniteConfigVitePlugin()` (Vite) or `IgniteConfigWebpackPlugin` (Webpack) when you want this file auto-loaded.

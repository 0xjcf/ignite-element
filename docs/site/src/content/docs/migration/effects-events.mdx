...
`emit` inside commands still works for now, but it logs:
...
- Current beta branch: deprecated, still supported.
- Next stabilization release: migration tooling and docs stay in place.

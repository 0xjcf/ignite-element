...
| Full `state`→`snapshot` rename (`expectState`→`expectSnapshot` + `result.snapshot`/`schema.snapshot`/record-trace) + `expectEvent` member form | `1781818974159` | `docs/v3-api-consistency.md` |

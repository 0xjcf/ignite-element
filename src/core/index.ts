export { default as igniteElementFactory } from "./IgniteElementFactory";
...
export { setGlobalStyles } from "./utils/globalStyles";
export type { RenderArgs } from "./utils/RenderArgs";

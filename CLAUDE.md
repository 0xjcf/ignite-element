...
5. **Implement**: Follow the commit plan. In Codex, use `.fas/state/codex-orchestration.json` and `.fas/state/codex-subagents-prompt.md` for delegated order and role boundaries. Do not combine or expand commit scope.

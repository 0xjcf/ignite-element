		...
		<div class="runtime-scroll">
			<section class="runtime-card">
				...
				<div class="component-contract">
					...
					{context.runtimeInspector.domainPolicyCards.map((domainPolicy) => (
						<section
							key="domain-policy"
			...
			<section class="runtime-card">
				...
				<div class="runtime-body">
					<section class="schema-section">
						<header>
							<strong>
								{context.runtimeInspector.schemaExplorer.manifest.heading}
							</strong>
							<span>
								{context.runtimeInspector.schemaExplorer.manifest.countLabel}
							</span>
						</header>
					...
					<section class="schema-section blueprint">
						<header>
							<strong>
								{context.runtimeInspector.schemaExplorer.blueprint.heading}
							</strong>
							<span>
								{context.runtimeInspector.schemaExplorer.blueprint.countLabel}
							</span>
						</header>
